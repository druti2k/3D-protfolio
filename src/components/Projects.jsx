...
const Projects = () => (
  <section id="projects">
    <motion.div variants={textVariant()}>
      <p className={`${styles.sectionSubText} text-gradient text-2xl font-semibold mb-2`}>🚀 My Work</p>
      <h2 className={`${styles.sectionHeadText} text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 drop-shadow-lg mb-6`}>Projects</h2>
    </motion.div>
